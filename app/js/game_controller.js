...
var GameController = function() {
    ...
    this.floorDeltaY = 50;
    this.floorScore = 1;
    this.speed = 50; //pixel per second;
    this.maxSpeed = 350;
    this.blood = 12;
    ...
    this.$people = $('.people');
    this.peopleSpeed = 180; //pixel per second;
    this.peopleRotateZ = 0;
    this.peopleRotateDelta = 25; //deg;
    this.peopleVerticalSpeed = 200; //pixel per second;
    this.peopleHeight = 0;
    this.peopleWidth = 0;
  ...
  GameController.prototype = {
    ...
    // 事件机制，利用 zepto trigger 来封装游戏状态事件
    ...
    jumpStart: function() {
      ...
      //暂存人物速度
      this.__tempPeopleSpeed = this.peopleSpeed;
      //跳跃模式，人物速度降低
      this.peopleSpeed = this.peopleSpeed / 2;
    },
    jumpEnd: function(hitTop) {
      ...
      //恢复人物速度
      this.peopleSpeed = this.__tempPeopleSpeed;
    },
    people: function(fps) {
      //人物纵向每帧移动距离
      var _deltaPeopleY = this.peopleSpeed / fps;
      //卷轴纵向每帧移动距离
    ...
    run: function(fps) {
      ...
      return this.animation = setInterval(function() {
        window.requestAnimationFrame(_this.core.bind(_this, fps));
      }, looptime);
    },
    stop: function() {
      clearInterval(this.animation); //暂停动画
